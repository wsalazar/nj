...
class HeadwayContentBlock extends HeadwayBlockAPI {
	...
	function add_comments_template() {
		...
		return HEADWAY_LIBRARY . '/blocks/core/content/comments-template.php';
	...
	function add_editor_style($css) {
		...
		/* DEPRECATED — USE REMOVE THEME SUPPORT INSTEAD */
		if ( defined('HEADWAY_DISABLE_EDITOR_STYLE') && HEADWAY_DISABLE_EDITOR_STYLE === true )
			return $css;
		...
		HeadwayCompiler::register_file(array(
			...
			'dependencies' => array(HEADWAY_LIBRARY . '/blocks/core/content/editor-style.php'),
			'enqueue' => false
		));
	...
	function setup_elements() {
		...
		$this->register_block_element(array(
			...
			'inherit-location' => 'inherit-heading'
		));
		...
		$this->register_block_element(array(
			...
			'properties' => array('fonts', 'text-shadow', 'borders' => array('border-color', 'border-bottom-width', 'border-style')),
			'inherit-location' => 'inherit-heading'
		));
		...
		$this->register_block_element(array(
			...
			'properties' => array('fonts', 'text-shadow'),
			'inherit-location' => 'inherit-sub-heading'
		));
		...
		$this->register_block_element(array(
			...
			'properties' => array('fonts', 'background', 'borders', 'text-shadow', 'rounded-corners'),
			'states' => array(
				'Hover' => 'a.more-link:hover',
				'Clicked' => 'a.more-link:active'
			)
		));
		...
		$this->register_block_element(array(
			...
			'properties' => array('background', 'borders', 'rounded-corners')
		));
...
class HeadwayContentBlockOptions extends HeadwayBlockOptionsAPI {
	...
	public $inputs = array(
		...
		'meta' => array(
			...
			'edit-link-format' => array(
				'type' => 'text',
				'label' => 'Edit Link Format',
				'name' => 'edit-link-format',
				'default' => ' | %edit_link%'
			)
		),
