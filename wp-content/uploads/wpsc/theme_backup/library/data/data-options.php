...
class HeadwayOption {
	...
	/**
	 * Start the data class.  Create options group variable and DB entry if it doesn't exist.
	 **/
	...
	public static function get($option = null, $group_name = false, $default = null) {
		...
		$data = Headway::fix_data_type($group_data[$option]);
	...
	public static function set($option = null, $value = null, $group_name = false) {
		...
		update_option('headway_option_group_' . $group_name, $group_data);
