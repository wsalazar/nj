...
class GridSetupPanel extends HeadwayVisualEditorPanelAPI {
	...
	public $inputs = array(
		...
		'wrapper' => array(
			...
			'wrapper-horizontal-padding' => array(
				'type' => 'slider',
				'name' => 'wrapper-horizontal-padding',
				'label' => 'Wrapper Horizontal Padding',
				'default' => 15,
				'tooltip' => 'This will change the space between the left and right of the wrapper and grid inside of it.',
				'unit' => 'px',
				'slider-min' => 0,
				'slider-max' => 75,
				'slider-interval' => 1,
				'callback' => 'gridStylesheet.update_rule("div.wrapper", {"padding-left": value + "px", "padding-right": value + "px"});'
			),
			
			'wrapper-vertical-padding' => array(
				'type' => 'slider',
				'name' => 'wrapper-vertical-padding',
				'label' => 'Wrapper Vertical Padding',
				'default' => 15,
				'tooltip' => 'This will change the space between the top and bottom of the wrapper and grid inside of it.',
				'unit' => 'px',
				'slider-min' => 0,
				'slider-max' => 75,
				'slider-interval' => 1,
				'callback' => 'gridStylesheet.update_rule("div.wrapper", {"padding-top": value + "px", "padding-bottom": value + "px"});'
			)
		),
