...
class HeadwayVisualEditorAJAX {
	...
	public static function method_load_block_options() {
		...
		$unsaved_options = Headway::post('unsaved_block_options', array());
		...
		if ( is_array($unsaved_options) )
			$block['settings'] = is_array(Headway::get('settings', $block)) ? array_merge($block['settings'], $unsaved_options) : $unsaved_options;
