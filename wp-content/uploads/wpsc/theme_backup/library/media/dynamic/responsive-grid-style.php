<?php
class HeadwayResponsiveGridDynamicStyle {
	...
	static function ipad_landscape() {
		...
		$column_width = HeadwayOption::get('column-width', 'general', HeadwayGrid::$column_width);
		$gutter_width = HeadwayOption::get('gutter-width', 'general', HeadwayGrid::$gutter_width);
		...
		$grid_width = ($column_width * $grid_number) + (($grid_number - 1) * $gutter_width);
		$wrapper_width = $grid_width + $horizontal_padding + $vertical_padding;
