...
class HeadwayGrid {
	...
	public static function init() {
		...
		self::$column_width = HeadwayOption::get('column-width', 'general', self::$default_column_width);
		
		self::$gutter_width = HeadwayOption::get('gutter-width', 'general', self::$default_gutter_width);
		
		self::$block_bottom_margin = HeadwayOption::get('block-bottom-margin', 'general', self::$default_block_bottom_margin);
	...
	public static function enqueue_canvas_assets() {
		...
		$grid_css_fragments = array(
			HEADWAY_LIBRARY . '/media/css/reset.css',
			HEADWAY_LIBRARY . '/media/css/grid.css',
			HEADWAY_LIBRARY . '/media/css/block-basics.css',
			HEADWAY_LIBRARY . '/media/css/content-styling.css',
			HEADWAY_LIBRARY . '/media/css/alerts.css',
			HEADWAY_LIBRARY . '/visual-editor/css/editor-iframe.css',
			HEADWAY_LIBRARY . '/visual-editor/css/editor-tooltips.css',
			HEADWAY_LIBRARY . '/visual-editor/css/editor-iframe-grid.css',
			HEADWAY_LIBRARY . '/visual-editor/css/editor-iframe-grid-block-content.css',
		...
		HeadwayCompiler::register_file(array(
			...
			'dependencies' => array(
				HEADWAY_LIBRARY . '/media/dynamic/style.php'
			)
		));
