...
class HeadwayRoute {
	...
	public static function maybe_run_trigger() {
		...
		//Cycle through
		switch ( Headway::get('headway-trigger') ) {
			...
			case 'thumbnail':
				Headway::load('resources/thumbnail');
			break;
	...
	public static function is_visual_editor() {
		...
		return Headway::get('visual-editor', false);
	...
	public static function is_trigger() {
		...
		return ( Headway::get('headway-trigger') ) ? true : false;
	...
	public static function is_theme_preview() {
		...
		return Headway::get('preview') == 1 && Headway::get('preview_iframe') == 1;
	...
	public static function is_visual_editor_iframe() {
		...
		return Headway::get('ve-iframe') && HeadwayCapabilities::can_user_visually_edit();
	...
	public static function is_grid() {
		...
		return self::is_visual_editor_iframe() && Headway::get('ve-iframe-mode') == 'grid';
