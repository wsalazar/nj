...
function headway_get_license_key() {
	...
	if ( defined('HEADWAY_LICENSE_KEY') )
		return apply_filters('headway_license_key', HEADWAY_LICENSE_KEY);

	return apply_filters('headway_license_key', HeadwayOption::get('license-key'));
...
function headway_gzip() {
	...
	if ( !$gzip = apply_filters('headway_gzip', true) )
		return false;
