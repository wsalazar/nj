...
class HeadwayWidgetAreaBlock extends HeadwayBlockAPI {
	...
	function setup_elements() {
		...
		$this->register_block_element(array(
			...
			'name' => 'Widget',
			'selector' => 'li.widget',
			'properties' => array('fonts', 'background', 'borders', 'text-shadow', 'box-shadow')
		));
		...
		$this->register_block_element(array(
			...
			'properties' => array('fonts', 'text-shadow', 'background', 'borders', 'box-shadow'),
		...
		$this->register_block_element(array(
			...
			'inherit-location' => 'inherit-links'
		));
