	...
	public function update_notice() {
		...
		if ( $valid_key === true ) {
			...
			if ( !$this->notify_only ) {
				...
				echo sprintf(__('<div id="update-nag">%s %s is now available, you\'re running %s! <a href="%s">Click here to update</a> or <a href="%s" target="_blank">learn more</a> about the update.</div>'), 
				...
				echo sprintf(__('<div id="update-nag">%s %s is now available, you\'re running %s! Go to the <a href="%s" target="_blank">Headway Dashboard</a> to download the latest version or <a href="%s" target="_blank">learn more</a> about the update.</div>'),
			...
			switch ( $valid_key ) {
				...
				case 'expired':
					echo sprintf(__('<div id="update-nag">%s %s is now available, you\'re running %s!  Your Headway license has expired.  Please visit the <a href="%s">Headway Dashboard</a> to renew your license so you can continue to receive updates.</div>'), 
						$this->name, $new_version, $this->current_version, HEADWAY_DASHBOARD_URL);
				break;

				default:
					echo sprintf(__('<div id="update-nag">%s %s is now available, you\'re running %s!  You will not be able to update until you enter a valid license key on the <a href="%s">Headway Options</a> panel.</div>'), 
