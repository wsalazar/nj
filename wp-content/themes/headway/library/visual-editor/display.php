...
class HeadwayVisualEditorDisplay {
	...
	public static function enqueue_scripts() {
		...
		HeadwayCompiler::register_file(array(
			...
			'fragments' => array(
				...
				HEADWAY_LIBRARY_DIR . '/visual-editor/js/editor.widget.grid.js',
	...
	public static function enqueue_styles() {
		...
		HeadwayCompiler::register_file(array(
			...
			'format' => 'css',
			'fragments' => array(
				HEADWAY_LIBRARY_DIR . '/visual-editor/css/editor-tooltips.css',
				HEADWAY_LIBRARY_DIR . '/visual-editor/css/editor.css',
				HEADWAY_LIBRARY_DIR . '/visual-editor/css/editor-inputs.css',
				HEADWAY_LIBRARY_DIR . '/visual-editor/css/editor-design.css',
	...
	public static function panel_top_mode_buttons() {
		...
		switch ( HeadwayVisualEditor::get_current_mode() ) {
			...
			case 'grid':
				...
				//echo '<span class="mode-button" id="insert-wrapper">Insert Wrapper</span>';
